...
public class lista_cliente extends Fragment implements adaptadorProceso.ListItemClick {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            recycler = view.findViewById(R.id.lista_cliente_recycler);
            ...
            ArrayList<objetoProceso> user = proceso.informacionProcesoCliente(String.valueOf(usuarios.obtenerValorAA()));
    ...
    public void onListItemClick(int clickedItem) {
        ArrayList<objetoProceso> listaProcesos = proceso.informacionProcesoCliente(String.valueOf(usuarios.obtenerValorAA()));
